...
public class RemoteContent extends GridPane {
	...
	public RemoteContent(Stage primaryStage) {
		...
		FXMLLoader fxmlLoader = new FXMLLoader(
				getClass().getResource("Remote.fxml"));
		...
		try {
			...
			toSend.placeholderProperty()
					.set(new Label("No message loaded / recognized"));
			received.placeholderProperty()
					.set(new Label("No message loaded / recognized"));
			...
			toSendKey.setCellValueFactory(
					new PropertyValueFactory<Field, String>("key"));
			toSendValue.setCellValueFactory(
					new PropertyValueFactory<Field, String>("value"));

			receivedKey.setCellValueFactory(
					new PropertyValueFactory<Field, String>("key"));
			receivedValue.setCellValueFactory(
					new PropertyValueFactory<Field, String>("value"));
	...
	public void handlerLoad() {
		...
		fileChooser.getExtensionFilters()
				.addAll(new FileChooser.ExtensionFilter("XML, TXT", exts));
	...
	public void handlerToSendSave() {
		...
		fileChooser
				.setInitialDirectory(new File(System.getProperty("user.dir")));
		fileChooser.getExtensionFilters()
				.addAll(new FileChooser.ExtensionFilter("XML", "*.xml"));
