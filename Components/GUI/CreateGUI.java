...
class MonitorTask implements Runnable {
	...
	private static final String incomingMessages = "IN\tConfirm|Connect|Reading|Alert\n";
	private static final String outgoingMessages = "OUT\tConnect|Setting:Activate|Setting:Deactivate|Setting:UpdateRecipients|Setting:SwitchUser|Setting:Kill";
